...
/*    @GetMapping("/homeOwn")
    ...
    public String loadYardManagerOwn(Model model, HttpSession session) {
        ...
        List<Yard> yardList = yardRepository.findAllByOwnPitch_IdOrderByIdDesc(userEntity.getIdOwn());
...
//        UserEntity userEntity = (UserEntity) session.getAttribute("user");
//        model.addAttribute("user", userEntity);
//        List<Yard> yardList = yardRepository.findAllByOwnPitch_Id(userEntity.getIdOwn());
//        model.addAttribute("yardList", yardList);
//        return "addPriceYard";
//    }
